...
[`src/compiler.rs`](../src/compiler.rs)), and the system linker resolves the
...
[`src/compiler.rs`](../src/compiler.rs) (`Type::Int` is already `i32`,
...
- [`src/compiler.rs`](../src/compiler.rs): `compile_to_executable`, where the
